...
var currentTarget=jQuery(this);currentTarget.bind('click',function(e){if(clickCount>1){return!0}
var attr=currentTarget.parent().attr('data-popup-id');var attr2=currentTarget.attr('data-popup-id');if(jQuery(e.originalEvent.target).closest('header').length&&(typeof attr=='undefined'||!attr)){if(typeof attr2=='undefined'||!attr2){return!0}}
